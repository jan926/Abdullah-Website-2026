...
-- https://supabase.com/dashboard/project/suyawzhvjfdlbukcyunj/sql/new
...
CREATE POLICY "site_config_insert_public" ON public.site_config FOR INSERT WITH CHECK (true);

DROP POLICY IF EXISTS "site_config_update_public" ON public.site_config;
CREATE POLICY "site_config_update_public" ON public.site_config FOR UPDATE USING (true);

DROP POLICY IF EXISTS "site_config_delete_public" ON public.site_config;
CREATE POLICY "site_config_delete_public" ON public.site_config FOR DELETE USING (true);
